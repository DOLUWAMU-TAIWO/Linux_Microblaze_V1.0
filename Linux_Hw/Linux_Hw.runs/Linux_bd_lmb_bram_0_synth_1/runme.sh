...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Linux_Microblaze_V1.0/Linux_Hw/Linux_Hw.runs/Linux_bd_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Linux_bd_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Linux_bd_lmb_bram_0.tcl
