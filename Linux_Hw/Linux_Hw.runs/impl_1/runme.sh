...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Linux_Microblaze_V1.0/Linux_Hw/Linux_Hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Linux_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Linux_bd_wrapper.tcl -notrace
