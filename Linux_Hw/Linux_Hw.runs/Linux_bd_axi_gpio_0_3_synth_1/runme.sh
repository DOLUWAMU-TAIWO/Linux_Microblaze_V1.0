...
HD_PWD='C:/Users/doluwamu.kaye/Documents/GitHub/Linux_Microblaze_V1.0/Linux_Hw/Linux_Hw.runs/Linux_bd_axi_gpio_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Linux_bd_axi_gpio_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Linux_bd_axi_gpio_0_3.tcl
